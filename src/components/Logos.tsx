...
export const Logos = () => {
  return (
    <section
      className="w-full bg-neutral-900/50 py-10 overflow-hidden border-y border-white/5"
      aria-label="Tecnologias utilizadas"
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        <span className="text-zinc-500 text-sm font-medium tracking-[0.2em] uppercase mb-8">
          Tecnologias que eu domino
        </span>
        
        <div className="flex overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)] w-full motion-reduce:animate-none [&>div]:motion-reduce:animate-none">
