  ...
  return (
    <section className="relative w-full py-32 px-4 overflow-hidden" id="contato">
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute -inset-[10px] opacity-20 hidden sm:block">
          <div className="absolute inset-0 bg-[repeating-linear-gradient(100deg,var(--color-brand-blue)_10%,var(--color-brand-cyan)_30%,var(--color-brand-purple)_50%,var(--color-brand-blue)_70%)] [background-size:200%_100%] motion-safe:md:animate-aurora mix-blend-screen filter blur-[40px] md:blur-[80px]" />
        </div>
      </div>
